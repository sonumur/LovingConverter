...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            { path: 'excel-to-pdf', element: <ConverterTool name="Excel to PDF" description="XLSX to PDF." icon={<FileJson />} onProcess={(f) => genericMockConversion(f, 'PDF')} /> },
            { path: 'powerpoint-to-pdf', element: <ConverterTool name="PowerPoint to PDF" description="PPTX to PDF." icon={<FileCode />} onProcess={(f) => genericMockConversion(f, 'PDF')} /> },
            { path: 'sign-pdf', element: <ConverterTool name="Sign PDF" description="Sign yourself or others." icon={<Stamp />} onProcess={(f) => f[0]} /> },
            ...
            { path: 'html-to-pdf', element: <ConverterTool name="HTML to PDF" description="Web to PDF." icon={<FileCode />} onProcess={(f) => f[0]} /> },
            { path: 'unlock-pdf', element: <ConverterTool name="Unlock PDF" description="Remove password." icon={<Unlock />} onProcess={(f) => f[0]} /> },
            ...
            { path: 'pdf-to-pdfa', element: <ConverterTool name="PDF to PDF/A" description="Archive format." icon={<FileText />} onProcess={(f) => f[0]} /> },
            ...
            { path: 'ocr-pdf', element: <ConverterTool name="OCR PDF" description="Scan to text." icon={<Search />} onProcess={(f) => f[0]} /> },
            { path: 'edit-pdf', element: <ConverterTool name="Edit PDF" description="Edit your PDF." icon={<Type />} onProcess={(f) => f[0]} /> },
            { path: 'scan-to-pdf', element: <ConverterTool name="Scan to PDF" description="Scan documents." icon={<Camera />} onProcess={(f) => f[0]} /> },
            { path: 'compare-pdf', element: <ConverterTool name="Compare PDF" description="Compare PDFs." icon={<ArrowLeftRight />} onProcess={(f) => f[0]} /> },
